...
| Ranking-aware probes | [result](../experiments/probe_compression_rank1.json), [runner](../experiments/run_probe_compression.py), [figure](../figures/ranking_preservation_rank1.png) | Exact objective/budget contract; pathology rank adaptation | Completed margin-5 pairwise objective for any/25-task candidates through `k=10`, all-known plus 70/30 holdout and 10×10 random baseline |
